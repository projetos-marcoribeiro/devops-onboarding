...
Guia completo sobre a stack de observabilidade: NewRelic, Prometheus, Grafana, Sentry, Kubecost e JiraOps (que está substituindo o PagerDuty). O Datadog é abordado no contexto da PU Teachable. Explica como cada ferramenta é usada, como o monitoramento é configurado automaticamente pelo Base Module e como navegar nas ferramentas durante um incidente.
