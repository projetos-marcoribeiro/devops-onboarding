...
Consuma os materiais na ordem sugerida pelo [Learning Path](#/training-camp/learning-path), não aleatoriamente. O contexto acumulado em cada etapa torna os materiais seguintes mais fáceis de absorver.
