...
Veja exemplos de justificativas no documento [`access-requests-examples.md`](#/getting-started/access-requests-examples).
...
- Consulte o documento [`access-requests-examples.md`](#/getting-started/access-requests-examples) para ver exemplos de solicitações já preenchidas.
