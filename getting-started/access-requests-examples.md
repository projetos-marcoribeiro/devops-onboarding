...
> ⚠️ **Antes de começar:** substitua `[email do fellow]` pelo email real do seu fellow em cada justificativa. Os botões "Abrir ticket" abrem o Service Desk com o título e a justificativa já preenchidos. Revise, ajuste o que for necessário e submeta.

---

## Como funciona

1. Clique no botão **"Abrir ticket no Service Desk"** de cada acesso abaixo
2. O formulário abre com título e justificativa já preenchidos
3. Selecione o sistema e perfil corretos nos campos do formulário
...
Abra um ticket para cada item abaixo.
