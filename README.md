...
➡️ [Getting Started](./getting-started) — acessos, ferramentas e setup do ambiente
➡️ [Platform Overview](./platform-overview) — arquitetura, AWS, EKS, CI/CD e GitOps
➡️ [Training Camp](./training-camp) — trilha de aprendizado guiado e skill matrix
➡️ [Hands-On Project](./hands-on) — deploy completo supervisionado
➡️ [Operations](./operations) — trabalho operacional do dia a dia
➡️ [Incident Management](./incident-management) — resposta a incidentes e postmortem
➡️ [On-call Readiness](./oncall-readiness) — checklist de prontidão para o plantão

Outros recursos úteis:

📖 [DevOps Journey](./devops-journey) — plano 30-60-90 dias e expectativas trimestrais
🔧 [DevOps Tools](./devops-tools) — kubectl, AWS CLI, hotctl, Docker
👥 [Team Resources](./team-resources) — mentoria, comunicação e TeamGuide
🏢 [Product Units](./product-units) — recursos específicos de cada PU
📘 [Glossário](./glossary) — termos e siglas da plataforma
📊 [Diagramas](./diagrams) — arquitetura, deploy e resposta a incidentes em Mermaid
